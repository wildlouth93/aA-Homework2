...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return function (dipatch) {
    _util_api_util__WEBPACK_IMPORTED_MODULE_0__["fetchSearchGiphys"](searchTerm).then(function (giphys) {
      return dispatchEvent(receiveSearchGiphys(giphys.data));
    });
  };
};
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    type: "GET",
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=dM79nPXasqEHVDQFcfTYChlsuhrDDVZz&limit=2")
  });
};
